...
const nextConfig: NextConfig = {
    ...
    env: {
        ...
        NORMAL_BUYER_TESTNET:
            process.env.NORMAL_BUYER_TESTNET || "0x11119d51e2ff85d5353abf499fe63be3344c0000",
        PRO_BUYER_TESTNET:
            process.env.PRO_BUYER_TESTNET || "0x11119d51e2ff85d5353abf499fe63be3344c0000",
        CHANGER_TESTNET:
            process.env.CHANGER_TESTNET || "0x11119d51e2ff85d5353abf499fe63be3344c0000",
        NORMAL_BUYER_MAINNET:
            process.env.NORMAL_BUYER_MAINNET || "0x11119d51e2ff85d5353abf499fe63be3344c0000",
        PRO_BUYER_MAINNET:
            process.env.PRO_BUYER_MAINNET || "0x11119d51e2ff85d5353abf499fe63be3344c0000",
        CHANGER_MAINNET:
